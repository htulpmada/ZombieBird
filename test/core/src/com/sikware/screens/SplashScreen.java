...
import com.sikware.TweenAccessors.SpriteAccessor;
import com.sikware.zbhelpers.AssetLoader;
import com.sikware.zombiebird.ZBGame;
...
;   }
    ...
    private void setupTween(){
        ...
        Tween.to(sprite, SpriteAccessor.ALPHA, .8f)
                .target(1).ease(TweenEquations.easeInOutQuad)
                .repeatYoyo(1, .4f).setCallback(cb)
